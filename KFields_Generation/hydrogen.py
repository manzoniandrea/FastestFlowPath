...
def field_generation(realization, operating_system):
    if operating_system == 'win':
        ...
        folder_name = "KFields_Generation"

        # Construct the file path
        file_path = os.path.join(current_directory, folder_name, "hydrogen_input.txt")

        # Open the file
        inputtxt = open(file_path, "r")
        ...
        while iteration < realization:
            ...
            exe_path = os.path.join(current_directory, folder_name, "hydrogen_win.exe")
            ...
            single_result = os.path.join(current_directory, folder_name, 'single_result.txt')

            with open(single_result, newline='') as f:
